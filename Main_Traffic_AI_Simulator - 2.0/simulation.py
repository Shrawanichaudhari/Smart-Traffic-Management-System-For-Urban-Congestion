...
speeds = {'car':2.25, 'bus':1.8, 'truck':1.8, 'bike':2.5, 'ambulance':2.8}  # average speeds of vehicles
...
def generateVehicles():
    while(True):
        # Spawn an ambulance occasionally (e.g. ~5% chance) so the roads aren't full of ambulances.
